<div x-data="{
    ...
    <form @submit.prevent="$wire.addMedia().then(() => {showError = selectedOptions.length === 0;});">
        ...
        <div class="space-y-6">
            ...
            <flux:textarea label="Overview" wire:model="form.overview" placeholder="Enter a brief overview"
                rows="4"></flux:textarea>

            <flux:input type="file" wire:model="image_path" accept="image/png, image/jpeg" label="Image"
                class="max-w-lg" />
