<div class="relative flex flex-col overflow-hidden rounded-lg p-6" wire:loading.class="opacity-50">
    @if ($this->media)
        @if ($this->imageUrl)
            <img src="{{ $this->imageUrl }}" class="h-full w-full rounded-lg shadow-lg" alt="{{ $this->media->title }}">
        @endif
        ...
        <p class="text-gray-700 dark:text-gray-300 text-sm sm:text-base uppercase mt-2"><strong>Type:</strong> {{ $this->media->type }}</p>
        <p class="text-gray-700 dark:text-gray-300 text-sm sm:text-base uppercase mt-1"><strong>Status:</strong> {{ $this->media->status }}</p>
        ...
        <p class="dark:text-gray-300 text-gray-600 mt-2 text-base leading-relaxed">{{ $this->media->overview }}</p>
        ...
        <flux:modal name="edit-media-modal">
            <livewire:edit-media :media="$this->media" />
        </flux:modal>
